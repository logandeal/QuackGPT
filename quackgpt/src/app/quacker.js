...
//     bigMessage,
//     targetLength = this.model.maxContext,
//     maxTries = 5
//   ) {
//     const summarizer = new Quacker(
...
//   async test() {
//     const summary = await this.summarizeMessage(
//       "Tell me how I might go about calculating 4 + 4 in code.",
//       50,
//       2
//     );
//     console.log(summary);
...
//     super(
//       "The following message was too big to summarize in " +
//         steps +
//         " steps: " +
//         bigMessage
//     );
